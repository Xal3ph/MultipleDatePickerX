...
###Forked from Multiple Date Picker
I forked this based on a conversation in [pull 24](https://github.com/arca-computing/MultipleDatePicker/pull/24)

###Version 1.3.4.1 (MonthPicker)
Added `hideButtons`.
...
MultipleDatePickerX is an Angular directive to show a simple calendar allowing user to select multiple dates, a callback is called, you can specify some off days or already selected days.
